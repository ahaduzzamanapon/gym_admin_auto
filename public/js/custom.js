$(document).ready(function () {
    ...
    //         });
    //         $("#demo .navbar-brand h1").replaceWith(
    ...
    $(".color1").click(function () {
        ...
        $(this)
            ...
            .find(".alert-class")
            .children("span")
            .replaceWith('<span>add class = "' + text + '"</span>');
    });
    $(".card-class span").click(function () {
        $(this)
            ...
            .find(".alert")
            .removeClass(
                "alert-danger alert-warning alert-light alert-primary alert-success alert-secondary alert-info alert-dark"
            )
