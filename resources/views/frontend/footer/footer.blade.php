        ...
        <div class="w-full lg:w-[30%] xl:w-[25%] text-center lg:text-start">
                ...
                <div class="flex items-center justify-center lg:justify-start gap-6 lg:gap-3 mt-3">
                    ...
                    <a href="{{ twitter_Link() }}" target="_blank">
                        <svg class="w-[18px] h-[15px]" viewBox="0 0 155 154" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M131.2 153.61H23.89C11.18 153.61 0.869995 143.3 0.869995 130.59V23.28C0.869995 10.57 11.18 0.26001 23.89 0.26001H131.2C143.91 0.26001 154.22 10.57 154.22 23.28V130.6C154.22 143.31 143.91 153.61 131.2 153.61Z" fill="#006BA6"/>
            ...
            <div class="w-full lg:w-[32%] lg:flex   justify-center  gap-36 lg:gap-8 mt-5 lg:mt-0">
                {{-- <div class="w-full lg:w-[50%] xl:w-[53%]">
                    <h1 class="text-20 leading-[26px] font-poppins font-bold text-[#006BA3] mb-3 text-center lg:text-left">Features</h1>
                ...
                <div class="w-full lg:w-[47%]">
                    <h1 class="text-20 leading-[26px] font-poppins font-bold text-[#006BA3] mb-3 text-center lg:text-left">Explore</h1>
                    <ul class="lg:space-y-1 flex lg:inline-block flex-wrap justify-center lg:justify-start items-center gap-4">
                        <li>
            ...
            <div class="space-y-3">
               ...
               <div class="flex items-center gap-3 lg:gap-6">
                <div class="flex items-center gap-3 ">
                    <span >
                        <svg class="w-[17px] h-[20px]" viewBox="0 0 17 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.17285 4.97095V14.4655L5.32671 9.71822L1.17285 4.97095Z" fill="#006BA3"/>
                            <path d="M1.99805 4.01978L7.25691 10.0299C7.92108 10.789 9.07943 10.789 9.7436 10.0299L15.0025 4.01978H1.99805Z" fill="#006BA3"/>
                            <path d="M10.5723 10.9771C10.0195 11.6095 9.28323 11.9585 8.50006 11.9585C7.71688 11.9585 6.98061 11.6095 6.42781 10.9771L6.15523 10.6655L2.00488 15.4088H14.9952L10.8449 10.6655L10.5723 10.9771Z" fill="#006BA3"/>
                            <path d="M11.6737 9.71822L15.8276 14.4655V4.97095L11.6737 9.71822Z" fill="#006BA3"/>
                            </svg>
                ...
                <div class="flex  gap-3 ">
                    <span class="mt-1">
                        <svg class="w-[14px] h-[17px]" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.0183 0.681489L0.777098 6.67836C-0.519844 7.37805 -0.0875301 9.5768 1.29593 9.5768H6.05192V15.074C6.05192 16.6731 7.95421 17.1731 8.55956 15.6737L13.7479 2.68055C14.1802 1.48086 13.056 0.181489 12.0183 0.681489Z" fill="#006BA3"/>
                        </svg> 
                    </span>
